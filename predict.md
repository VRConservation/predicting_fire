...
For old-growth there does look like more of which a relationship. Zonal stats or a regression to sum this and see if it is more than anecdotal.

What happens when we examine old-growth and species diversity with fire?

# Solutions
Moving forward, several integrated solution sets can support forest health and reduced fire risk:
